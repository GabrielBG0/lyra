  ...
  return (
    <div className="flex items-center py-1.5 min-h-5.5">
      ...
      <div className="ml-auto flex gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
        <button
          className="w-5.5 h-5.5 flex items-center justify-center rounded text-faint hover:bg-elev hover:text-secondary transition-colors border-none bg-transparent cursor-grab"
