...
import { serializeSection, parseSection, looksLikeSection } from '../sectionClipboard'
...
describe('serializeSection', () => {
  ...
  it('includes section_type and name in the header', () => {
    const out = serializeSection(makeSection({ section_type: 'verse', name: 'Verse 1' }))
...
describe('parseSection', () => {
  ...
  it('accepts all valid section types', () => {
    const types = ['intro', 'verse', 'pre-chorus', 'chorus', 'bridge', 'outro', 'custom'] as const
